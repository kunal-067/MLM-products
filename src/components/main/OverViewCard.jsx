        ...
        <div className={`bg-[#fff] m-1 p-3 px-4 ${className}`}>
            ...
            <div>
                ...
                <div className="flex flex-col mb-4">
                    ...
                    <div className="flex justify-between">
                        <input disabled={true} className="bg-gray-300 pl-2 rounded-bl-md w-full" type="text" name="registration" placeholder="Referral Link" value={`https://mlm-products.vercel.app/signup?ref=${referralCode || 'null'}`} />
                        <span className={`${copied == 2 ? 'bg-green-600' : 'bg-blue-600'} p-2 rounded-r-md`} onClick={() => copyText(`https://mlm-products.vercel.app/signup?ref=${referralCode || 'null'}`, 2)}>
